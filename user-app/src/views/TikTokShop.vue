...
const loadCategories = async () => {
  try {
    ...
    const categoryIcons: Record<string, string> = {
      ...
      'Beauty & Personal Care': 'https://images.unsplash.com/photo-1596462502278-27b2c045efd7?w=120&h=120&fit=crop&crop=center&auto=format&q=80',
      ...
      'Hair Care': 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=120&h=120&fit=crop&crop=center&auto=format&q=80',
      ...
      'Meat & Seafood': 'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=120&h=120&fit=crop&crop=center&auto=format&q=80',
