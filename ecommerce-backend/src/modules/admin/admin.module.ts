...
@Module({
  imports: [
    TypeOrmModule.forFeature([Admin, Product, Merchant, Order, User, MerchantProduct])
  ],
  controllers: [AdminController, TestAdminController, RecommendProductController, AdminRechargeAuditController],
